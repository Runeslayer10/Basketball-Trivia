 ...
 */
public class afterRuleF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Well done Finishing the Foul Rules Questions!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(afterRuleF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new afterRuleF().setVisible(true);
            }
        });
    }
