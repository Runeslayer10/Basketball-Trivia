 ...
 */
public class afterNBA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Well done Finishing the NBA Knowledge Questions!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(afterNBA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
