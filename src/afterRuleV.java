 ...
 * January 25th, this page is just telling the user that he/she has finished this set of questions
 */
public class afterRuleV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Click the Button to go back to the title page!");

        backButton.setBackground(new java.awt.Color(255, 255, 255));
        backButton.setText("TitlePage");
        ...
        jLabel2.setText("Well done Finishing the Rules Violations Questions!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(afterRuleV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new afterRuleV().setVisible(true);
            }
        });
    }
